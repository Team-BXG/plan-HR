...
def create_django_tables():
    ...
    try:
        ...
        print("✓ Django tables created")
    except Exception as e:
        print(f"✗ Error creating Django tables: {str(e)}")
...
def main():
    """Main function"""
    print("🚀 Employee Management System - Complete Database Setup")
    print("=" * 65)
    
    # Step 1: Create Django tables
    create_django_tables()
    
    # Step 2: Create custom tables
    create_custom_tables()
    
    # Step 3: Create Django users
    create_django_users()
    ...
    print("   2. Open browser: http://127.0.0.1:8000/api/auth/login/")
    print("   3. Test login with above credentials")
    print("   4. Build React frontend to connect to APIs")
