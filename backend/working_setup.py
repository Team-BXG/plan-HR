...
def main():
    """Main function"""
    print("🚀 Employee Management System - Working Setup")
    print("=" * 65)
    ...
    print("   Dashboard: http://127.0.0.1:8000/api/auth/dashboard/")
    print("   Employees: http://127.0.0.1:8000/api/employees/")
    print("   Departments: http://127.0.0.1:8000/api/departments/")
    print("   Attendance: http://127.0.0.1:8000/api/attendance/")
    print("   Leave: http://127.0.0.1:8000/api/leave/")
    print("\n🚀 Next Steps:")
    print("   1. Start server: python manage.py runserver")
    print("   2. Test APIs with Postman/curl")
    print("   3. Build React frontend to connect to these APIs")
    print("   4. All backend functionality is ready!")
